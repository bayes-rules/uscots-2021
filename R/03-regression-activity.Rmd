...
We have provided `.Rmd` file for this activity, if you prefer to use R file please run `knitr::purl("R/03-regression-activity.Rmd", "R/03-regression-activity.R")` in the Console.
