...
HI MINE :). I'd also add something about pretending not to have already seen the data, and maybe the prior plausible model lines? (Though i'm not sure that the prep materials included those packages.)
